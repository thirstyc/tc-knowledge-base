...
export function renderHead({ title, description, lang = 'en', assetPrefix = '', alternates = [] } = {}) {
...
<link rel="stylesheet" href="${assetPrefix}styles.css" />${alternateLinks}
</head>`;
}
...
export function renderHeader({ currentNav = null, lang = 'en', assetPrefix = '', frHref = null, enHref = null } = {}) {
  ...
  const navLink = (hrefBase, labelEn) => {
    ...
    return `<a href="${assetPrefix}${hrefBase}"${currentNav === hrefBase ? ' aria-current="page"' : ''}>${label}</a>`;
  };

  const langToggle = isFr
    ? `<span class="lang"><a class="off" href="${enHref ?? '#'}">En</a><span>|</span><a href="#" aria-current="page">Fr</a></span>`
    : `<span class="lang"><a href="#" aria-current="page">En</a><span>|</span><a class="off" href="${frHref ?? '#'}">Fr</a></span>`;

  return `<body>
  <header class="site-header">
    <a class="brand" href="${assetPrefix}index.html"><img src="${assetPrefix}assets/tc-monogram.png" alt="Thirsty Cunt" /></a>
    <nav class="nav">
...
export function renderFooter({ lang = 'en', assetPrefix = '', frHref = null, enHref = null } = {}) {
  const isFr = lang === 'fr';
  const langToggle = isFr
    ? `<a class="off" href="${enHref ?? '#'}">En</a><span>|</span><a href="#" aria-current="page">Fr</a>`
    : `<a href="#" aria-current="page">En</a><span>|</span><a class="off" href="${frHref ?? '#'}">Fr</a>`;
  return isFr
