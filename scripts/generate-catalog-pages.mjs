...
// A ceiling on a grape page's answer list, not a target. At 60 it was cutting
// four pages off mid-list -- Pinot Noir and Sauvignon Blanc match 104 answers
// each, Chardonnay 97, Champagne 71 -- and because the list is an
// (source_doc, id) sort, the answers it dropped were simply the alphabetically
// unlucky ones, several of which had no other page linking them at all. 120
// clears the largest with headroom. Every other grape is under 60 already.
const GRAPE_ANSWER_LIMIT = 120;
